...
${prefix}topinv => يوريك أكثر واحد جاب إنفتس 
      `)
...
client.on('message', message => {
 ...
 client.on('guildCreate', guild => {
  client.channels.get("498963676192047116").send(`**تم اضافة البوت في سيرفر جديد مبروكك
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=534156368018669618&permissions=8&scope=bot`)
        .setThumbnail(" 
		")        
     message.channel.sendEmbed(embed);
       }
...
if (message.content.startsWith('=bcall')){
 if (message.author.id !== '524231382734602242') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '524231382734602242') return;
